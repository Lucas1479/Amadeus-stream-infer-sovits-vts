...
class TTS:
    ...
    def init_bigvgan(self):
        if self.bigvgan_model is not None:
            return
        self.bigvgan_model = BigVGAN.from_pretrained(r"F:\BaiduNetdiskDownload\GPT-SoVITS\GPT-SoVITS-v3lora-20250401\GPT_SoVITS\pretrained_models\models--nvidia--bigvgan_v2_24khz_100band_256x", use_cuda_kernel=False)  # if True, RuntimeError: Ninja is required to load C++ extensions
